...
//import icu.d4peng.cloud.common.db.request.SuperRequest;
...
//        SuperRequest<icu.d4peng.cloud.common.db.entity.Test> superRequest = new SuperRequest<>();
//        superRequest.setCurrent(4);
//        superRequest.setSize(3);
//        this.testMapper.selectPage(superRequest, null);
//        superRequest.getRecords().forEach(System.out::println);
//    }
//
//    @Test
